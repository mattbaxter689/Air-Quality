...
pub struct RawHourlyData {
    ...
    pub carbon_dioxide: Vec<Option<f32>>,
    pub nitrogen_dioxide: Vec<Option<f32>>,
    pub sulphur_dioxide: Vec<Option<f32>>,
    pub ozone: Vec<Option<f32>>,
    pub methane: Vec<Option<f32>>,
    pub uv_index: Vec<Option<f32>>,
    pub dust: Vec<Option<f32>>,
    pub aerosol_optical_depth: Vec<Option<f32>>,
    pub us_aqi: Vec<Option<f32>>,
}
...
pub struct AirQualityHourly {
    ...
    pub dust: Option<f32>,
    pub aerosol_optical_depth: Option<f32>,
